...
public class TestConfig{
	...
	public static String from = "durgesh.chandangole19@vit.edu";
	public static String password = "vit1234$";
	public static String[] to ={"dchandangole@gmail.com","durgesh.chandangole99@gmail.com"};
